...
- Mesa com 4 jogadores: o personagem escolhido pelo jogador + 3 NPCs. O
  assento 0 (frente, vazio) deixa de existir. [A CONFIRMAR]
...
- Balao, animacoes (Apostar, Dudo, Comemorar, Castigo) e castigo do jogador
  ...
  continua como efeito de tela por cima do castigo do personagem. [A CONFIRMAR]
...
- O log de historico (chat) so existe durante uma partida: some e reinicia
  no Novo jogo. [A CONFIRMAR]

---

## Bloco A — Fable (Blender + arquitetura; exige Blender conectado)

- [ ] A1. Roupas e tons de pele, no .blend, reexportando os 4 .glb com as
...
- [ ] A2. Iluminacao: rostos estao estourando. Baixar DirectionalLight e luz
...
- [ ] A3. Layout da mesa e camera: Main.tscn com 4 assentos (fundo = jogador,
      ...
      Validar por captura.
- [ ] A4. Arquitetura da escolha de personagem: autoload "Partida.gd"
...
- [ ] A5. dialogues.json: novas categorias por personagem, com textos:
...
- [ ] A6. Atualizar game_bible.md (jogador na mesa, 4 jogadores, log, falas
...
- [ ] B1. Menu e selecao: Menu.tscn funcional (cartao por personagem com nome
      ...
      balao sai do modelo, castigo do personagem no modelo + torta na tela.
...
- [ ] B9. [A CONFIRMAR] "Ao iniciar nova rodada": instrucao chegou
      incompleta. Preencher com o que deve acontecer.
